    ...
    public class JugadoresDAL
    {
...

        {
           ...
           List<Jugador> _lista = new List<Jugador>();
              ...
              "SELECT id_jugador, nombre, apellido, puesto,fecha_alta, salario, altura FROM Jugadores1 WHERE nombre ='{0}' or apellido='{1}'", pNombre, pApellido), BD_Conexion.BD_Conectar());
               ...
               while (_reader.Read())
               {
                   ...
                   pJugador.fecha_alta = _reader.GetString(4);
                   pJugador.salario = _reader.GetInt32(5);
                   pJugador.altura = _reader.GetDouble(6);
